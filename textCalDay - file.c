...
//以下农历换算部分代码来自： http://blog.csdn.net/syrchina/article/details/8538516 
#include <string.h>  
...
int prnl(int year, int month, int day)  
{  
...
const	char en[60][10] = {"   ____   " ," .'    '. " ,"|  .--.  |" ,"| |    | |" 
				,"|  `--'  |" ," '.____.' " ,"   __     " ,"  /  |    " ,"  `| |    " 
				,"   | |    " ,"  _| |_   " ," |_____|  "  ,"  _____   " ," / ___ `. " 
				,"|_/___) | " ," .'____.' " ,"/ /_____  " ,"|_______| "  ,"  ______  " 
				," / ____ `." ," `'  __) |" ," _  |__ '." ,"| \\____) |" ," \\______.'"  
				," _    _   " ,"| |  | |  " ,"| |__| |_ " ,"|____   _|" ,"    _| |_ " 
				,"   |_____|"  ," _______  " ,"|  _____| " ,"| |____   " ,"'_.____''." 
				,"| \\____) |" ," \\______.'"  ,"  ______  " ,".' ____ \\ " ,"| |____\\_|" 
...
main(){
    ...
    p = localtime(&timep);
		...
		freopen("calday.txt", "w", stdout);
		
    printf("     %d年%d月     ", (1900+p->tm_year), (1+p->tm_mon), p->tm_mday);
    printf("%s\n", wday[p->tm_wday]);
